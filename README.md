...
面向新员工、导师、站点负责人、培训管理员、管理员和超级管理员的培养管理平台。当前版本是可本地运行和继续迭代的 MVP，核心能力包括人员信息管理、课程签到、闯关任务、综合评价、考试题库、权限隔离、审计日志和个人培养进度展示。
...
- 人员信息：统一完成人员查询、新增编辑、板块与双导师维护、Excel 导入导出，以及员工发起/管理员审批服务站变更。
- 课程与任务：课程签到、闯关任务、培养进度展示。
- 综合评价：批次评分方案、三方月评、加扣分、月度和季度锁定快照。
- 考试管理：题目专业标签、手动/随机/一人一卷组卷、考试计划、自动保存、自动阅卷、成绩发布导出、补考次数和防作弊事件。
