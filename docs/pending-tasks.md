...
- 最后核对日期：2026-08-13
- GitHub：PR #3、生产验收修复 PR #5～#7、综合评价优化 PR #9、评分任务编排 PR #11 及任务优先评分范围 PR #12 均已合并；PR #12 的应用功能合并提交为 `3a611a44c8d1fc79c4a953148d1afbfade4e535f`。
- 云服务器：已部署 `main@3a611a44` 对应的 IP 版生产 JAR，SHA-256 为 `7ef1009d48211b5ae386543bfa3399ffe3a3a39de8119f2ae2bbf9f229f15ce5`。
- 线上验收：应用健康状态为 `UP`，Flyway V27 成功；评分范围规则表、成员表和分配来源字段已落库，评分任务页面返回 200，未登录新概览 API 正确返回 401。此前公开 OSS、私有课件直传/水印预览/禁止原件下载、私有附件签名下载及删除清理验收继续有效。
