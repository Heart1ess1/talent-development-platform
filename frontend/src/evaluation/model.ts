...
export const componentDefinitions=[
  ...
  {code:'MENTOR' as const,label:'导师评价',shortLabel:'导师',description:'直属导师结合日常培养表现评分',enabled:'mentorEnabled',weight:'mentorWeight',maxScore:'mentorMaxScore'},
  {code:'STATION' as const,label:'站点评价',shortLabel:'站点',description:'服务站负责人评价现场表现',enabled:'stationEnabled',weight:'stationWeight',maxScore:'stationMaxScore'},
...
export function emptyTemplate(){return {
  ...
  stationEnabled:true,stationWeight:15,stationMaxScore:100,
