...
async function createQuestion(){
  ...
  ElMessage.success('题目已加入题库');question.stem='';question.explanation='';await load()
}
...
<style scoped>
.page-head p{margin:6px 0 0}.card-head{display:flex;align-items:center;justify-content:space-between}.question-form{max-width:760px}.import-panel{padding:12px 4px}
</style>
