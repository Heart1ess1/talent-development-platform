...
export function createEmptyQuestion(){
  return {id:null,bankId:null,type:'SINGLE',stem:'',options:[] as string[],answer:null as string|string[]|boolean|null,score:null as number|null,explanation:'',tags:[] as string[]}
}
