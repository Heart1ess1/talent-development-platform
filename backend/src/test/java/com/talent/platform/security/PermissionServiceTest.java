...
class PermissionServiceTest {
  ...
  @Test void fixedRolePermissionMatrix(){
    ...
    assertThat(service.permissions("TRAINING_ADMIN")).contains(Permissions.EMPLOYEE_UPDATE,Permissions.COURSE_MANAGE,Permissions.TASK_MANAGE,Permissions.TASK_REVIEW,Permissions.EXAM_MANAGE).doesNotContain(Permissions.EMPLOYEE_WRITE,Permissions.USER_EMPLOYEE_MANAGE);
    assertThat(service.permissions("ADMIN")).contains(Permissions.EMPLOYEE_UPDATE,Permissions.EMPLOYEE_WRITE,Permissions.USER_EMPLOYEE_MANAGE,Permissions.USER_OPS_ROLE_MANAGE,Permissions.MASTER_MANAGE,Permissions.EVALUATION_VIEW).doesNotContain(Permissions.USER_ADMIN_MANAGE,Permissions.EVALUATION_SUBMIT);
