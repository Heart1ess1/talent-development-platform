...
class PermissionServiceTest {
  ...
  @Test void fixedRolePermissionMatrix(){
    ...
    assertThat(service.permissions("MENTOR")).contains(Permissions.EMPLOYEE_READ,Permissions.EVALUATION_SUBMIT,Permissions.TASK_SCORE).doesNotContain(Permissions.TASK_MANAGE,Permissions.TASK_REVIEW);
    assertThat(service.permissions("STATION_MANAGER")).contains(Permissions.EVALUATION_SUBMIT,Permissions.TASK_SCORE).doesNotContain(Permissions.ATTENDANCE_MANAGE);
